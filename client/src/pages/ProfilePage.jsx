      ...
      max-sm:flex-col-reverse rounded-lg'>
        ...
        className='flex flex-col flex-1 gap-5 p-10 '>
          ...
          cursor-pointer'>
            ...
            : assets.avatar_icon } alt="profile picture" 
          ...
          type="text" placeholder='Your HOT Name' required 
          className='p-2 border border-gray-500 rounded-md 
          focus:outline-none focus:ring-2 focus:ring-violet-500'/>

          <textarea onChange={(e)=>setBio(e.target.value)} value={bio} 
          placeholder='Tell us Who you are The UFO is waiting......  '
          className='p-2 border border-gray-500 rounded-md focus:outline-none 
          focus:ring-2 focus:ring-violet-500' rows={4} required>
          </textarea>
        ...
        mx-10 max-sm:mt-10 ${selectedImg && 'rounded-full'}`} src={authUser?.profilePic||assets.logo_icon} alt="logo_icon" />
      </div>
